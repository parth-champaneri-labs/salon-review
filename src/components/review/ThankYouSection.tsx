  ...
  return (
    <>
      <section className="thank-you bg-charcoal px-5 py-16 text-center text-ivory sm:py-24" aria-labelledby="thank-you-title">
        ...
        <h2 id="thank-you-title" className="closing-title">Thank you for<br /><em>taking the time.</em></h2>
        <p className="mt-7 text-sm leading-relaxed text-[#ccc5b8]">Your feedback helps us make every visit better<br />We truly appreciate hearing from you.</p>
      </section>
